...
import { Flame, Mail, ChevronDown, Loader2 } from "lucide-react";
  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold">Simmr</CardTitle>
        <CardDescription>
          The social cooking community. Join the cult.
        </CardDescription>
      </CardHeader>
