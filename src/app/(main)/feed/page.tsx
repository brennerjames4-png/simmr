...
import { getDraftCount } from "@/queries/inspiration";
import { PostCard } from "@/components/feed/post-card";
import { InspirationFAB } from "@/components/inspiration/inspiration-fab";
...
export default async function FeedPage() {
  ...
  const hasKitchenSetup = user.kitchenInventory !== null;
