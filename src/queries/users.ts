...
export async function getUserByUsername(
  ...
  const result = await db
    .select({
      ...
      defaultMealTypes: users.defaultMealTypes,
      mealPrepEnabled: users.mealPrepEnabled,
      defaultCookServingsMultiplier: users.defaultCookServingsMultiplier,
      nutritionGoals: users.nutritionGoals,
      tasteProfile: users.tasteProfile,
      bypassCode: users.bypassCode,
